ThemeHeaderJustifyDesigner = React.createClass
  ...
  render: ->
    className = "navbar navbar-static-top header-justified"
...
window.ThemeHeaderJustifyDesigner = ThemeHeaderJustifyDesigner
