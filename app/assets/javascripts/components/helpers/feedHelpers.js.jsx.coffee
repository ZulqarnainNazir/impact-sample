feedHelpers = {
  ...
  editFeedSettings: (groupId, block) ->
    ...
    $('#feed_settings_content_type_job_paid').prop 'checked', (block.content_types || '').indexOf('PaidJob') >= 0
    $('#feed_settings_content_type_job_volunteer').prop 'checked', (block.content_types || '').indexOf('VolunteerJob') >= 0
