BlockImagePlacement = React.createClass
  render: ->
    if this.props.kind is 'embeds'
      ...
      `<img className="center-block img-responsive" src={this.props.image_attachment_url} alt={this.props.image_alt} title={this.props.image_title} style={{marginBottom: 15, maxWidth: '100%'}}/>`
