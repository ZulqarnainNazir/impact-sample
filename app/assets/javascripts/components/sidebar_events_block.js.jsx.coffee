SidebarEventsBlock = React.createClass
  propTypes:
  ...
  render: ->
    `<div className="webpage-container" data-type="sidebar_events">
  ...
  renderInterior: ->
    if this.props.block
      `<div className="webpage-block">
        ...
        <div className="webpage-sidebar-events">
          <SidebarEventsBlockContent {...this.props.block} />
        </div>
...
window.SidebarEventsBlock = SidebarEventsBlock
