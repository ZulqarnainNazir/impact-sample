# encoding: utf-8
# Extends the base RSS parser for Chamber Nation/Chamber Organizer feeds for feeds in the Pacific Time Zone.
#TODO - Need to Extend this to allow for other timezones. See event_metadata_hash method. Once adjusted, we could roll in Webster City Chamber parser into this parser.
module Feeds
  module Parsers
