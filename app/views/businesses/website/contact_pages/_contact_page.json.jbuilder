...
json.defaultBackgroundColor contact_page.website.background_color
json.defaultForegroundColor contact_page.website.foreground_color
json.defaultLinkColor contact_page.website.link_color
