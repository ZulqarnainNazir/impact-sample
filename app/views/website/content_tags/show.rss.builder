...
xml.rss version: '2.0', 'xmlns:media' => 'http://search.yahoo.com/mrss/', 'xmlns:atom' => 'http://www.w3.org/2005/Atom' do
  xml.channel do
    xml.title "Tag – #{@content_tag.name}"
    xml.link website_content_tag_url(@content_tag)
    xml.atom :link, href: website_content_tag_url(@content_tag), rel: 'self', type: 'application/rss+xml'
    xml.language 'en-US'
    xml.ttl '40'
