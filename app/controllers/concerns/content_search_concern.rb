module ContentSearchConcern
  ...
  def get_content(business: nil, embed: nil, query: nil, content_types: ApplicationController::ALL_CONTENT_TYPES, content_category_ids: [], content_tag_ids: [], order: "desc", page: 1, per_page: 10, published: true)
