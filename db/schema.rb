...
ActiveRecord::Schema.define(version: 20_160_915_183_628) do
    ...
    add_index 'before_afters', %w(id slug), name: 'index_before_afters_on_id_and_slug', unique: true, using: :btree
    ...
    add_index 'blocks', %w(frame_type frame_id), name: 'index_blocks_on_frame_type_and_frame_id', using: :btree
    add_index 'blocks', %w(link_type link_id), name: 'index_blocks_on_link_type_and_link_id', using: :btree
    ...
    add_index 'content_categorizations', %w(content_item_type content_item_id), name: 'index_content_categorizations_on_polymorphic_content_item', using: :btree
    ...
    add_index 'content_taggings', %w(content_item_type content_item_id), name: 'index_content_taggings_on_content_item_type_and_content_item_id', using: :btree
    ...
    add_index 'event_definitions', %w(id slug), name: 'index_event_definitions_on_id_and_slug', unique: true, using: :btree
    ...
    add_index 'galleries', %w(id slug), name: 'index_galleries_on_id_and_slug', unique: true, using: :btree
    ...
    add_index 'offers', %w(id slug), name: 'index_offers_on_id_and_slug', unique: true, using: :btree
    ...
    add_index 'placements', %w(placer_type placer_id), name: 'index_placements_on_placer_type_and_placer_id', using: :btree
    ...
    add_index 'posts', %w(id slug), name: 'index_posts_on_id_and_slug', unique: true, using: :btree
    ...
    add_index 'quick_posts', %w(id slug), name: 'index_quick_posts_on_id_and_slug', unique: true, using: :btree
    ...
    add_index 'webpages', %w(website_id pathname), name: 'index_webpages_on_website_id_and_pathname', unique: true, using: :btree
...
ActiveRecord::Schema.define(version: 20160915183628) do
  ...
  add_foreign_key "post_sections", "posts"
  add_foreign_key "quick_posts", "businesses"
>>>>>>> 7d1d30296f2e795a3f95e16692cb5b71b7002da5
end
